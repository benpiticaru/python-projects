...
## Tag objects
soup_object = BeautifulSoup('<h1 attribute_1 = "Heading Level 1"">Future Trends for IoT in 2018"</h1>' , features="html.parser")
tag = soup_object.h1
type(tag)
...
## Different commands to look at sections of a webpage
